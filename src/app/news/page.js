...
const SEEDED_UPDATES = [
  {
    id: 'seed-15',
    title: 'Nearby Clarke County Pushes Residents to Speak Up at July 7 Hearing on 765-kV Line',
    body: 'The Clarke County Board of Supervisors is urging residents to attend a Valley Link open house on July 7 (4–7:30 p.m., Ruritan Building at the Clarke County Fairgrounds in Berryville) about the proposed 765-kV transmission line. While the county has no approval authority over the project, supervisors say they will independently review impacts on conservation lands, historic and cultural resources, scenic highways, agriculture, and public facilities.\n\nChairman David Weiss has warned the line offers potential damage to the county with no corresponding benefit.',
    created_at: '2026-06-21T00:00:00Z',
    seeded: true,
  },
  {
    id: 'seed-14',
    title: 'Supervisors Advance Five Land-Use Changes',
    body: 'The Frederick County Board of Supervisors forwarded five of six proposed Comprehensive Policy Plan Amendments for further review. One could expand the county\'s Sewer & Water Service Area and Urban Development Area for residential development near the future fourth high school, and three involve potential conservation easements.\n\nThe only amendment rejected for further study was the Gibson property, 33.7 acres zoned RA at 3615 Front Royal Pike (U.S. 522) in the Shawnee District. The application proposed a switch to "industrial" that many assumed was for a data center, though planning staff said the application gave no such indication.',
    created_at: '2026-06-18T00:00:00Z',
    seeded: true,
  },
  {
    id: 'seed-13',
    title: 'Local Delegates Line Up Against the Valley North Power Corridor',
    body: 'Area state legislators issued a joint statement opposing the newly announced Valley North Project, which would run from the existing Amos substation in Putnam County, West Virginia, east through Frederick and Clarke counties before ending at the proposed Rocky Point substation in Frederick County, Maryland.\n\nLegislators argued that Northern Virginia\'s power demands shouldn\'t repeatedly fall on the Shenandoah Valley while the region sees none of the benefits. Valley North is the third new transmission line proposed through Frederick County, alongside NextEra\'s MARL line and FirstEnergy\'s Gore-Doubs-Goose Creek upgrades.',
    created_at: '2026-06-11T00:00:00Z',
    seeded: true,
  },
  {
    id: 'seed-12',
    title: 'Planning Commission Rejects the Clear Brook Data Center Campus, 10-0',
    body: 'The Frederick County Planning Commission unanimously recommended denial of the rezoning for Virginia Technology Park, a proposed 220-acre data center campus in Clear Brook, after a nearly four-hour meeting. The application described 10 to 11 data center buildings, three substation pads, up to 288 generators, and 24,000 square feet of office space, with no named end-user.\n\nCommissioners cited a lack of detail and enforceable proffers, and roughly 30 residents marched in opposition beforehand. The recommendation was set to go to the Board of Supervisors on July 8.',
    created_at: '2026-06-03T00:00:00Z',
    seeded: true,
  },
  {
    id: 'seed-11',
    title: 'Winchester Gateway Data Center Stalls as Applicant Backs Off July Hearing',
    body: 'A conditional-use permit application for the proposed 71.85-acre Winchester Gateway data center campus in Kernstown will not go before the Planning Commission for its July 1 public hearing, after concerns raised at a commission work session. The applicant said it needed more time to address power infrastructure, building height, screening, and low-frequency noise.\n\nIn a related move, Equus Capital Partners pulled its Virginia Technology Park rezoning from the July 8 Board of Supervisors agenda, postponing it indefinitely.',
    created_at: '2026-06-10T00:00:00Z',
    seeded: true,
  },
  {
    id: 'seed-10',
    title: 'Warren County Brings On Frederick\'s Former EDA Chief Amid Data Center Worries',
    body: 'Warren County has hired Patrick Barker, the longtime former head of Frederick County\'s Economic Development Authority, as its new economic development director at a $163,000 salary, starting June 3. Barker stepped down from the Frederick EDA in February after 24 years, following a joint work session in which supervisors signaled they weren\'t satisfied with the EDA\'s direction.\n\nThe hire draws scrutiny given Warren County\'s own ongoing data center debates and the Frederick EDA\'s prior role promoting development.',
    created_at: '2026-06-04T00:00:00Z',
    seeded: true,
  },
  {
    id: 'seed-9',
    title: 'Frederick Water Bills Climb Again Starting July 1',
    body: 'New Frederick Water rates take effect July 1, 2026, the final step in a schedule adopted in 2022 that set 8% consumption rate increases each July from 2022 through 2026. The increases have been tied to inflation and drought-related costs.\n\nIn recent years the utility has had to buy additional water from the City of Winchester due to historically low quarry levels, and its new treatment plant has faced delays.',
    created_at: '2026-06-12T00:00:00Z',
    seeded: true,
  },
  {
    id: 'seed-8',
    title: 'Worsening Drought Triggers Valley-Wide Water Warning',
    body: 'Virginia\'s drought warning has expanded to cover most of the state: 94 counties and 33 cities, including much of the Shenandoah Valley. Officials say groundwater levels and river flows have dropped to emergency levels and could worsen as summer approaches, with dry conditions already affecting agriculture and raising wildfire risk.\n\nBy mid-June, extreme drought covered 38% of Virginia, and local livestock farmers reported first-cutting hay down 75% or more.',
    created_at: '2026-05-18T00:00:00Z',
    seeded: true,
  },
  {
    id: 'seed-7',
    title: 'Shenandoah River Hits Record Lows Across Every Major Branch',
    body: 'Friends of the Shenandoah River reported that the river hit record-low flow levels amid the ongoing drought, with the North Fork, South Fork, and Main-stem all setting records on May 9, 2026. Subsequent monitoring showed water levels continuing to recede through late May and into June.',
